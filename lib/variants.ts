...
export const variants = {
  primary:
    "bg-primary text-primary-foreground shadow hover:bg-primary-600 dark:hover:bg-primary-400 focus-visible:outline-primary",
  primaryMuted:
    "bg-primary-muted text-primary-muted-foreground  focus-visible:outline-primary",
};
