...
const switchVariants = cva(
  [
    "peer relative isolate inline-flex h-5 w-9 shrink-0 items-center rounded-full p-0.5 transition duration-200 ease-in-out data-[state=unchecked]:inset-shadow-sm dark:data-[state=unchecked]:shadow-none",
  ...
  ],
  {
    variants: {
      variant: {
        // -- primary --
        primary: [
          "outline-primary data-[state=checked]:bg-primary data-[state=unchecked]:bg-muted",
        ...
        // -- secondary --
        secondary: [
          "outline-secondary data-[state=checked]:bg-secondary data-[state=unchecked]:bg-muted",
          "dark:data-[state=unchecked]:bg-faded dark:data-[state=unchecked]:inset-ring dark:data-[state=unchecked]:inset-ring-border",
        ],
        "secondary-muted": [
  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block size-4 rounded-full bg-background shadow-xs transition-all duration-200 ease-in-out outline-none data-[disabled]:bg-base-50 dark:backdrop-blur-lg dark:data-[state=checked]:bg-foreground dark:data-[state=unchecked]:bg-white/25 dark:data-[state=unchecked]:data-[disabled]:bg-base-700",
          thin
            ? "inset-ring inset-ring-border data-[state=checked]:translate-x-[calc(--spacing(5)+1px)] data-[state=unchecked]:-translate-x-px"
