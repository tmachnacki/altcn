  ...
  ],
  {
    variants: {
      ...
      variant: {
        // -- base --
        default: [
          "bg-background shadow-xs outline-1 -outline-offset-1 outline-border hover:not-focus-visible:not-aria-invalid:outline-hover-border dark:bg-faded",
        ...
        muted: [
          "bg-muted -outline-offset-1 hover:not-focus-visible:not-aria-invalid:bg-accent",
          "file:bg-base-500 file:text-white dark:file:bg-base-600 dark:file:text-base-50",
