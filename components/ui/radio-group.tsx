...
const radioGroupItemVariants = cva(
  "peer size-4 shrink-0 rounded-full border border-input shadow-xs hover:border-border-hover focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:hover:border-input disabled:opacity-50 data-[state=checked]:border-primary data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground dark:not-data-[state=checked]:bg-faded aria-invalid:border-destructive aria-invalid:outline-destructive",
  {
    variants: {
      variant: {
        primary:
