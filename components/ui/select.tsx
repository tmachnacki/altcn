...
const selectTriggerVariants = tv({
  ...
  variants: {
    size: {
      sm: [
        "[--select-trigger-gap:--spacing(2)]",
        "h-(--size-md) sm:h-(--size-sm)",
        "text-sm",
        "gap-(--select-trigger-gap) px-2.5 py-1.5",
        "*:data-[slot=select-value]:gap-(--select-trigger-gap)",
      ...
      md: [
        ...
        "gap-(--select-trigger-gap) px-3 py-2",
        "*:data-[slot=select-value]:gap-(--select-trigger-gap)",
        "**:[svg]:not-[[class*='size-']]:size-(--icon-lg) sm:**:[svg]:not-[[class*='size-']]:size-(--icon-md)",
      ],
      lg: [
        "[--select-trigger-gap:--spacing(2.5)]",
        "h-(--size-xl) sm:h-(--size-lg)",
        "text-lg sm:text-base",
        "gap-(--select-trigger-gap) px-3.5 py-2.5",
        "*:data-[slot=select-value]:gap-(--select-trigger-gap)",
