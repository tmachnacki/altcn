    ...
    variants: {
      ...
      variant: {
        ...
        outline: [
          ...
          "aria-invalid:outline-destructive/80 aria-invalid:hover:not-disabled:outline-destructive aria-invalid:focus-visible:outline-destructive aria-invalid:disabled:bg-destructive-faded aria-invalid:data-[placeholder]:text-destructive-placeholder dark:aria-invalid:bg-destructive-faded",
        ],
        ...
        underlined: [
          ...
          "aria-invalid:shadow-[inset_0_-1px_0_0_--alpha(var(--color-destructive)/80%)] aria-invalid:hover:not-disabled:not-focus-visible:shadow-[inset_0_-1px_0_0_var(--color-destructive)] aria-invalid:focus-visible:shadow-[inset_0_-2px_0_0_var(--color-destructive)] aria-invalid:data-[placeholder]:text-destructive-placeholder",
        ],
