  ...
  "inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap ring-ring outline-outline transition-[color,box-shadow] duration-100 focus-visible:ring-4 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[variant*='-tron']:before:absolute data-[variant*='-tron']:before:-top-px data-[variant*='-tron']:before:left-[10%] data-[variant*='-tron']:before:h-[2px] data-[variant*='-tron']:before:w-[80%] data-[variant*='-tron']:before:bg-gradient-to-r data-[variant*='-tron']:before:from-transparent data-[variant*='-tron']:before:to-transparent data-[variant*='-tron']:before:opacity-0 data-[variant*='-tron']:before:transition-opacity data-[variant*='-tron']:before:duration-300 data-[variant*='-tron']:before:content-[''] data-[variant*='-tron']:after:absolute data-[variant*='-tron']:after:-bottom-px data-[variant*='-tron']:after:left-[10%] data-[variant*='-tron']:after:h-[2px] data-[variant*='-tron']:after:w-[80%] data-[variant*='-tron']:after:bg-gradient-to-r data-[variant*='-tron']:after:from-transparent data-[variant*='-tron']:after:to-transparent data-[variant*='-tron']:after:opacity-100 data-[variant*='-tron']:after:transition-opacity data-[variant*='-tron']:after:duration-300 data-[variant*='-tron']:after:content-[''] data-[variant*='-tron']:hover:bg-gradient-to-b data-[variant*='-tron']:hover:before:opacity-100 data-[variant*='-tron']:hover:after:opacity-0 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "primary-tron":
          "relative border border-primary/30 bg-transparent text-primary-muted-foreground shadow-xs before:via-primary after:via-primary hover:border-primary/40 hover:from-primary/20 hover:to-primary/5",
        "primary-shadow":
          "bg-primary text-primary-foreground shadow-lg shadow-primary/40 hover:bg-primary/90",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/90",
        "secondary-muted":
          "bg-secondary-muted text-secondary-muted-foreground hover:bg-secondary-muted/80",
        "secondary-tron":
          "relative border border-secondary/30 bg-transparent text-secondary-muted-foreground shadow-xs before:via-secondary after:via-secondary hover:border-secondary/40 hover:from-secondary/20 hover:to-secondary/5",
        "secondary-shadow":
          "bg-secondary text-secondary-foreground shadow-lg shadow-secondary/40 hover:bg-secondary/90",
        destructive:
        ...
        "destructive-tron":
          "relative border border-destructive/30 bg-transparent text-destructive-muted-foreground shadow-xs before:via-destructive after:via-destructive hover:border-destructive/40 hover:from-destructive/20 hover:to-destructive/5",
        "destructive-shadow":
        ...
        "success-tron":
          "relative border border-success/30 bg-transparent text-success-muted-foreground shadow-xs before:via-success after:via-success hover:border-success/40 hover:from-success/20 hover:to-success/5",
        "success-shadow":
          "bg-success text-success-foreground shadow-lg shadow-success/40 hover:bg-success/90",
        warning:
        ...
        "warning-tron":
          "relative border border-warning/30 bg-transparent text-warning-muted-foreground shadow-xs before:via-warning after:via-warning hover:border-warning/40 hover:from-warning/20 hover:to-warning/5",
        "warning-shadow":
          "bg-warning text-warning-foreground shadow-lg shadow-warning/40 hover:bg-warning/90",
        outline:
